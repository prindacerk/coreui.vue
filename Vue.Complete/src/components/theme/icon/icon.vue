		...
		<div class="card" id="spinner">
			...
			<div class="card-body">
				...
				<div class="row text-center">
					...
					<div class="col-6 col-sm-4 col-md-3 col-lg-2">
						<i class="fa fa-cog fa-lg mt-4 fa-spin"></i><br>cog
					</div>
					<div class="col-6 col-sm-4 col-md-3 col-lg-2">
						<i class="fa fa-gear fa-lg mt-4 fa-spin"></i><br>gear <span class="text-muted">(alias)</span>
					</div>
					<div class="col-6 col-sm-4 col-md-3 col-lg-2">
						<i class="fa fa-refresh fa-lg mt-4 fa-spin"></i><br>refresh
					</div>
					<div class="col-6 col-sm-4 col-md-3 col-lg-2">
						<i class="fa fa-spinner fa-lg mt-4 fa-spin"></i><br>spinner
					</div>
