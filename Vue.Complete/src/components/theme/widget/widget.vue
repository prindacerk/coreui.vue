				...
				<div class="card">
					<div class="card-body">
						...
						<div class="progress-xs my-3 progress">
							<div role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="25" class="progress-bar bg-success" style="width: 25%;" />
						</div>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="card">
					<div class="card-body">
						...
						<div>Lorem ipsum...</div>
						<div class="progress-xs my-3 progress">
							<div role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="25" class="progress-bar bg-info" style="width: 25%;" />
						</div>
						<small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
					</div>
				</div>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="card">
					<div class="card-body">
						...
						<div>Lorem ipsum...</div>
						<div class="progress-xs my-3 progress">
							<div role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="25" class="progress-bar bg-warning" style="width: 25%;" />
						</div>
						<small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
					</div>
				</div>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="card">
					<div class="card-body">
						...
						<div>Lorem ipsum...</div>
						<div class="progress-xs my-3 progress">
							<div role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="25" class="progress-bar bg-danger" style="width: 25%;" />
						</div>
						<small class="text-muted">Lorem ipsum dolor sit amet enim.</small>
					</div>
				</div>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="card text-white bg-primary">
					<div class="card-body">
						<div class="h4 m-0">89.9%</div>
						<div>Lorem ipsum...</div>
						<div class="progress-white progress-xs my-3 progress">
			...
			<div class="col-md-2 col-sm-6">
				<div class="card text-white bg-info">
					<div class="card-body">
						...
						<div class="h4 mb-0">87.500</div>
						<small class="text-muted text-uppercase font-weight-bold">Visitors</small>
						<div class="progress-white progress-xs mt-3 mb-0 progress">
							<div role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="25" class="progress-bar" style="width: 25%;" />
						</div>
					</div>
				</div>
